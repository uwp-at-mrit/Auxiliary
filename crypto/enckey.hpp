...
namespace WarGrey::SCADA {
	...
	WarGrey::SCADA::Natural enc_natural(uint32 literal_id);
	WarGrey::SCADA::Natural enc_natural(const char* literal_id, size_t start = 0U);
	...
	WarGrey::SCADA::Natural enc_hardware_uid_encrypt(WarGrey::SCADA::Natural& HW_ID, const WarGrey::SCADA::Natural& M_KEY);
}
